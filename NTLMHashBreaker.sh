...
echo "Hashes were written to this file: $output_file."
...
if [ "$response" == "yes" ]; then
  ...
  # Match cracked hashes with users
  echo "$cracked_hashes" | while IFS= read -r cracked_line; do
    ...
    # Find the user corresponding to the decrypted hash
